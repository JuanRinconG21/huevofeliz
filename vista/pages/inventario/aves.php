                    ...
                    try {
                      while ($fila = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <tr>
                                        ...
                                        <td><?php echo $fila['estadoSalud'] ?></td>
                                        <td><?php echo $fila['fechaVacunacion'] ?></td>
                                        <td><?php echo $fila['fechaIngreso'] ?></td>
                                        <td><?php echo $fila['fechaDeRetiro'] ?></td>
                                        <td><?php echo $fila['vacunas'] ?></td>
                                        <td><?php echo $fila['Entorno'] ?></td>
                                        <td><?php echo $fila['sintomas'] ?></td>
                                        <td><?php echo $fila['NombreLoteAves'] ?></td>
                                    </tr>
                  <?php 
                  }   
                    } catch (\Throwable $th) {
