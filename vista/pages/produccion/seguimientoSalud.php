                                            ...
                                            <form>
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="idVacuna" min="1" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre de lote">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleSelectBorder">Id de aves</label>
