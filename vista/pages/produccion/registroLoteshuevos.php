...
//traigo  el lote huevos
$sql = "SELECT * from `lotehuevo`";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 style="text-align: center;" class="m-0">Registrar lote de huevos</h1>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="../../../controller/registroLoteshuevos.php" method="post">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Identificador del lote</label>
                                                        <input name="identificadorLote" min="1" type="text" class="form-control" id="exampleInputEmail1" placeholder="Identificador del lote">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="precio" class="custom-select form-control-border" id="exampleSelectBorder">
                                                            <?php foreach ($fila1 as $precio) { ?>

                                                                <option value="<?php echo $precio['idPrecios'] ?>"><?php echo $precio['precio'] ?></option>
