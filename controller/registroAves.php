...
if (
    ...
    try {
        ...
        $sql1 =  "INSERT INTO `aves` (`idAves`, `especie`, `peso`, `estadoSalud`, `fechaVacunacion`, `fechaIngreso`, `LoteAves_idLoteAves`) VALUES (NULL, :especie, :peso, :estadoSalud, :fechaVa, :fechaIn,  :loteave);";
