    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 style="text-align: center;" class="m-0">Registrar lote de aves </h1>
            </div>
            <!-- /.col -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="../../../controller/registroLotesAves.php" method="post">
                        <div class="card-body">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Nombre del lote</label>
                            <input name="loteAve" min="1" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre de lote">
                          </div>
              ...
              <hr>
              <h1 style="text-align: center;">Listar lotes</h1>
              <div class="card">
