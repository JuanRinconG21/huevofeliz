        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../../pages/inventario/huevos.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                  ...
                  <tbody>
                    ...
                    try {
                      while ($fila1 = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                        <tr>
                                        <td><?php echo $fila1['especie'] ?></td>
                                        <td><?php echo $fila1['peso'] ?></td>
                                        <td><?php echo $fila1['estadoSalud'] ?></td>
                                        <td><?php echo $fila1['fechaVacunacion'] ?></td>
                                        <td><?php echo $fila1['fechaIngreso'] ?></td>
                                        <td><?php echo $fila1['fechaDeRetiro'] ?></td>
                                        <td><?php echo $fila1['vacunas'] ?></td>
                                        <td><?php echo $fila1['entorno'] ?></td>
                                        <td><?php echo $fila1['sintomas'] ?></td>
                                        <td><?php echo $fila1['NombreLoteAves'] ?></td>
                                    </tr>
                  <?php 
                  }   
                    } catch (\Throwable $th) {
