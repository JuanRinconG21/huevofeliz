          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../../pages/logistica/EntregasConfirmadas.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="m-0 mb-3 mt-3 text-center">Entregas Confirmadas</h1>
              <div class="card mb-5">
                <div class="card-header">
                  <h3 class="card-title">Tabla Entregas Confirmadas</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
